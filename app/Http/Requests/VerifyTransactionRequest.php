...
class VerifyTransactionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        // For tokenization (transactionType = '9'), productId is required, amount is not
        ...
        if ($transactionType === $tokenizedType) {
            // Tokenized payment: productId is required
    ...
    public function messages(): array
    {
        return [
            ...
            'productId.required' => 'Product ID is required for tokenized payment',
